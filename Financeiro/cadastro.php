...
if (isset($_POST['btnFinalizar'])) {
    ...
    $ret = $objdao->CriarCadastro($nome, $email, $senha, $repetirSenha);
}
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <form method="post" action="cadastro.php">
                            ...
                            <div class="form-group input-group">
                                <span class="input-group-addon"><i class="fa fa-lock"></i></span>
                                <input type="password" class="form-control" placeholder="Repita a senha criada" name="repetirSenha" id="rsenha" />
                            </div>

                            <button onclick="return ValidarCadastro()" name="btnFinalizar" class="btn btn-success ">Finalizar Cadastro</button>
                            <hr />
