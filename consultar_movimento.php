...
<title>Consultar Movimento</title>
<?php
            ...
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <h5>Consulte todos os movientos em um determinado período</h5>
                    </div>
                </div>
                <!-- /. ROW  -->
                <hr />
                <form method="post" action="consultar_movimento.php">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control" placeholder="Coloque a data do movimento" name="data_inicial" id="dt_inicial" value="<?= $dt_inicial ?>" />
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label>Data Final</label>
                            <input type="date" class="form-control" placeholder="Coloque a data do movimento" name="data_final" id="dt_final" value="<?= $dt_final ?>" />
                        </div>
                    </div>
                    <center>
                        <button onclick="return ValidarConsultaPeriodo()" name="btnPesquisar" class="btn btn-info">Pesquisar</button>
                    </center>
                </form>
                <hr>
                                                                    ...
                                                                    <div class="modal-dialog">
                                                                        <div class="modal-content">
                                                                            ...
                                                                            <div class="modal-body">
                                                                                ...
                                                                                <b>Conta:</b> <?= $movs[$i]['banco_conta'] ?> / Ag. <?= $movs[$i]['agencia_conta'] ?> - Numero <?= $movs[$i]['numero_conta'] ?><br>
                                                                                <b>Valor:</b> R$ <?= $movs[$i]['valor_movimento'] ?><br>
                                                                            </div>
